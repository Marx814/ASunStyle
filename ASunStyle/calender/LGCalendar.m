...
- (void)setUp
{
    self.backgroundColor = UIColorFromHex(0xfed7ed, 1);
    [self.layer setMasksToBounds:YES];
    [self.layer setBorderWidth:0.5];
    [self.layer setBorderColor:UIColorFromHex(0xee008d, 1).CGColor];
    ...
    for (int i = 0; i < weekSymbols.count; i++) {
        ...
        weekdayLabel.textColor = UIColorFromHex(0xee008d, 1);
    ...
    collectionView.backgroundColor = UIColorFromHex(0xfed7ed, 1);
    ...
    _backgroundColors[@(LGCalendarCellStateSelected)]    = UIColorFromHex(0xf00093, 1);
    _backgroundColors[@(LGCalendarCellStatePlaceholder)] = [UIColor clearColor];
    _backgroundColors[@(LGCalendarCellStateToday)]       = [UIColor clearColor];
    
    _titleColors = [NSMutableDictionary dictionaryWithCapacity:5];
    _titleColors[@(LGCalendarCellStateNormal)]      = UIColorFromHex(0xee008d, 1);
    ...
    _titleColors[@(LGCalendarCellStateToday)]       = UIColorFromHex(0xee008d, 1);
    _titleColors[@(LGCalendarCellStateWeekend)]       = UIColorFromHex(0xee008d, 1);
