...
- (void)initializePageControl {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreenWidth - 95, CGRectGetHeight(self.frame) - 22, 95, 22)];
    _pageControl.hidesForSinglePage = YES;
    _pageControl.alpha = 0.8;
    _pageControl.userInteractionEnabled = NO;
    _pageControl.currentPageIndicatorTintColor = UIColorFromHex(0xff7733, 1);
    _pageControl.pageIndicatorTintColor = UIColorFromHex(0xd9d9d9, 1);
